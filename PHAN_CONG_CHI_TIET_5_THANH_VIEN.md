...
| **2.1** | **Thành viên 2: Đỗ Hoàng Phúc** (Data & Lab)                | 1    | **Cài đặt Lab Environment**         | • Ubuntu 18.04+: Mininet, Ryu, Scapy, tshark, tcpdump<br>• Review topology (5 switches, 8 hosts, IP config)<br>• Verify connectivity: ping test h_pc1→h_web1, h_att1→h_web1<br>• Setup Ryu controller: port 6653, verify "connected" logs<br>• Test capture: tcpdump trên s2, verify pcap packets<br>• Tạo dir: data/raw, data/features, logs                                                                                                                                                                                                                                                  | Hết tuần 1 | `setup_environment.sh` (tự động), `LAB_SETUP_GUIDE.md`, Mininet+Ryu chạy OK                                                  |
